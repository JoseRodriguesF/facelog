            ...
            <div class="menu-relatorio">
                ...
                <form>
                    <div class="div-status">
                        <h3 class="titulo">Tí­tulo:<br><br><textarea name="titulo" id="titulo">variavel</textarea></h3>
                        <h3 class="status">Status:<br><p>Pendentes</p></h3>
                    </div>
                    <h3 class="descricao">Descrição do Erro:<br><br><textarea name="" id="descricao">variavel</textarea></h3>
