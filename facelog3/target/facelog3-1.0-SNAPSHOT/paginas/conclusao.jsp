        ...
        <div class="main-container">
            ...
            <div class="menu-relatorio">
                ...
                <form>
                    ...
                    <div class="MTTs">
                        <h3>(MTTA) Confimação - inicio:<p id="mtta1">data</p></h3>
                        <h3>(MTTA) Confimação - fim:<p id="mtta2">data</p></h3>
                        <h3>(MTTD) Diagnóstico - inicio:<p id="mttd1">data</p></h3>
                        <h3>(MTTD) Diagnóstico - fim:<p id="mttd2">data</p></h3>
                    </div>
                    <br>
