...
<%
    ...
    try {
        ...
        String query = "SELECT * FROM concluidos";
...
<head>
    ...
    <title>Relatórios resolvidos</title>
...
<body>
    ...
    <main>
        ...
        <div class="menu-relatorio">
                <h2 class="nome-menu">Relatórios de conclusão<hr class="blue-line"></h2>
            <table border="1">
                <thead>
                    <tr>
                        <th>Título</th>
                        <th>Início do incidente</th>
                        <th>Fim do incidente</th>
                        <th>Setor afetado</th>
                        <th>Urgência</th>
                        <th>Ações</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= rs.getTimestamp("fim_incidente") %></td>
                        <td><%= rs.getString("setor") %></td>
                        <td><%= rs.getString("urgencia") %></td>
                        <td>
                            <a href="${pageContext.request.contextPath}/paginas/conclusao.jsp?id=<%= rs.getInt("id_relatorio") %>" class="btn-acessar">
                                Acessar
                            </a>
                        </td>
                    </tr>
